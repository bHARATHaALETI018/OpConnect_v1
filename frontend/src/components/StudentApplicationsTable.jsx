  ...
  return (
    <div>
      <div className="flex justify-around items-center w-full border-b border-dashed border-b-2 mb-3">
        ...
        transition ease-in-out bg-blue-500 hover:translate-y-1 hover:scale-110 hover:bg-indigo-500 "
        >
          <p className="capitalize">Opp. in Diff. companies</p>
      ...
      {applications.length === 0 ? (
        <div className="flex flex-col gap-3 text-center my-32 text-2xl font-semibold">
          <h1>Opps...</h1> <h1>You don't have any applications.</h1>
        </div>
      ) : (
        <div>
