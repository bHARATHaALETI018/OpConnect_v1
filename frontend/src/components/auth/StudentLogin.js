...
const StudentLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error("Invalid Email 0r Password", {
        position: toast.POSITION.TOP_CENTER,
        autoClose: 3000, // Display the toast for 3 seconds
      });
      setLoading(false);
        ...
        <div className="mb-6 flex flex-col">
          ...
          <div className="flex flex-row">
            <input
              ...
              id="password"
              className="shadow border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline flex-1"
            ...
            />
            <button
              className="flex-0 shadow border rounded  py-1 px-2 text-white justify-center active:text-white "
